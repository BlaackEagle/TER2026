...
def tracer_influence_chunk_points(cibles_rouges, fichiers_csv, labels_tailles):
    ...
    # 4. Finitions
    plt.title("Distribution des scores BTP vs Bruit selon la taille du Chunk", fontsize=16, fontweight='bold')
    plt.xlabel("Hyper-paramètre : Taille du segment (en mots)", fontsize=13)
    ...
    plt.tight_layout()
    plt.savefig("distribution_chunk.png", dpi=300, bbox_inches='tight')
    print("Graphique sauvegardé : distribution_chunk.png")
...
mes_labels = ["10 mots", "20 mots", "30 mots", "40 mots", "50 mots", "60 mots"]
