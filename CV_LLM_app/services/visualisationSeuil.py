...
def tracer_influence_chunk_points(cibles_rouges, fichiers_csv, labels_tailles):
    ...
    # 4. Finitions
    plt.title("Distribution des scores BTP vs Bruit selon le seuil d'attribution bonus", fontsize=16, fontweight='bold')
    plt.xlabel("Hyper-paramètre : Seuil d'attribution du bonus (selon similarité cosinus *100)", fontsize=13)
    ...
    plt.tight_layout()
    plt.savefig("distribution_seuil.png", dpi=300, bbox_inches='tight')
    print("Graphique sauvegardé : distribution_seuil.png")
...
mes_labels = ["Seuil 40", "Seuil 50", "Seuil 55", "Seuil 60"]
